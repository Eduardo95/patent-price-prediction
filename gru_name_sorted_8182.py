...
import numpy as np
'''
通过gru的方式预测，数据集是8182条的专利名称,重采样
'''
pkl_file = open('data_directory\\patent_name_word_vectors_using_jieba_one_hot_padding_sorted_8182.pkl', 'rb')
...
price_low = one_hot_padding[:586]
price_high = one_hot_padding[7946:]
price_middie = one_hot_padding[586:7946]
