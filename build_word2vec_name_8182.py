...
'''
这个文件用来根据8182个专利名称建立一个word2vec的向量表
'''
output = open('data_directory\\name_vectors_one_hot_without_padding_8182.pkl', 'rb')
one_hot = pickle.load(output)
output.close()
output = open('data_directory\\name_dict_8182.pkl', 'rb')
...
with tf.Session() as sess:
    ...
    output = open('data_directory\word2vec_name_128dim_8182_2.pkl', 'wb')
